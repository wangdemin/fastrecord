    ...
    <Form ref="formRecord" :model="formRecord" label-position="right" :label-width="180" :rules="ruleRecord">
      ...
      <div class="part part3">
        <Card :bordered="false">
          ...
          <FormItem prop="c3" label="制造单位" style="width:1000px;">
          ...
          <FormItem prop="c30" label="备案方" style="width:1000px;">
            <Input type="text" v-model="formRecord.c30" placeholder="备案方" :disabled="help.c30"></Input>
            <Icon type="ios-help-circle-outline" size="20" v-if="help.c30" @click="showModal2('c30')"></Icon>
          </FormItem>
          <FormItem prop="c4" label="产品规格型号" style="width:1000px;">
            <Input type="text" v-model="formRecord.c4" placeholder="规格型号" readonly :disabled="help.c4"></Input>
            <Icon type="ios-help-circle-outline" size="20" v-if="help.c4" @click="showModal2('c4')"></Icon>
          </FormItem>
          <FormItem prop="c2" label="商标" style="width:1000px;">
            <Input type="text" v-model="formRecord.c2" placeholder="商标" :disabled="help.c2"></Input>
          ...
          <FormItem prop="c11" label="类型" style="width:1000px;">
            <RadioGroup v-model="formRecord.c11">
              <Radio label="分体式" :disabled="help.c11">分体式</Radio>
              <Radio label="整体式" :disabled="help.c11">整体式</Radio>
            </RadioGroup>
            <Icon type="ios-help-circle-outline" size="20" v-if="help.c11" @click="showModal2('c11')"></Icon>
          </FormItem>
          <FormItem prop="c57" style="width:1000px;">
            <RadioGroup v-model="formRecord.c57" @on-change="clearRelevantData">
              <Radio label="单冷式" :disabled="help.c57">单冷式</Radio>
              <Radio label="热泵型" :disabled="help.c57">热泵型</Radio>
            </RadioGroup>
            <Icon type="ios-help-circle-outline" size="20" v-if="help.c57" @click="showModal2('c57')"></Icon>
          </FormItem>
          <FormItem prop="c8" label="能效等级" style="width:1000px;">
            <RadioGroup v-model="formRecord.c8">
              <Radio label="1" :disabled="help.c8">1级</Radio>
              <Radio label="2" :disabled="help.c8">2级</Radio>
              <Radio label="3" :disabled="help.c8">3级</Radio>
            </RadioGroup>
          ...
          <table id="table1">
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c5">
                  <Input type="text" v-model="formRecord.c5" :disabled="help.c5"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c25">
                  <Input type="text" v-model="formRecord.c25" :disabled="disabledc25 || help.c25"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c25" @click="showModal2('c25')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c33">
                  <Input type="text" v-model="formRecord.c33" :disabled="formRecord.c57 !== '热泵型' || help.c33"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c33" @click="showModal2('c33')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c34">
                  <Input type="text" v-model="formRecord.c34" :disabled="formRecord.c57 !== '热泵型' || help.c34"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c42">
                  <Input type="text" v-model="formRecord.c42" :disabled="disabledc42 || help.c42"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c42" @click="showModal2('c42')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c43">
                  <Input type="text" v-model="formRecord.c43" :disabled="formRecord.c57 !== '热泵型' || help.c43"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c43" @click="showModal2('c43')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c44">
                  <Input type="text" v-model="formRecord.c44" :disabled="formRecord.c57 !== '热泵型' || help.c44"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c6">
                  <Input type="text" v-model="formRecord.c6" :disabled="disabledc6 || help.c6"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c6" @click="showModal2('c6')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c35">
                  <Input type="text" v-model="formRecord.c35" :disabled="help.c35"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c35" @click="showModal2('c35')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c36">
                  <Input type="text" v-model="formRecord.c36" :disabled="help.c36"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c37">
                  <Input type="text" v-model="formRecord.c37" :disabled="disabledc37 || help.c37"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c37" @click="showModal2('c37')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c38">
                  <Input type="text" v-model="formRecord.c38" :disabled="formRecord.c57 !== '热泵型' || help.c38"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c38" @click="showModal2('c38')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c39">
                  <Input type="text" v-model="formRecord.c39" :disabled="formRecord.c57 !== '热泵型' || help.c39"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c39" @click="showModal2('c39')"></Icon>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td colspan="4">备注：额定制冷量、额定制热量、全年能源消耗效率、制冷季节耗电量、制热季节耗电量为热泵型转速可控型房间空气调节器必填项；额定制冷量、制冷季节能源消耗效率、制冷季节耗电量为单冷式转速可控型房间空气调节器必填项。</td>
            </tr>
          </table>
        </Card>
      </div>
      <div class="part part4">
        <Card :bordered="false">
          ...
          <FormItem prop="c9" label="备案标识开始使用日期" style="width:1000px;">
            <DatePicker type="date" style="width: 200px" v-model="formRecord.c9" :disabled="help.c9"></DatePicker>
        ...
        <Card :bordered="false">
          ...
          <table id="table3">
              ...
              <td width="30%">
                <FormItem prop="c10">
                  <RadioGroup v-model="formRecord.c10">
                    <Radio label="三相" :disabled="help.c10">三相</Radio>
                    <Radio label="单相" :disabled="help.c10">单相</Radio>
                  </RadioGroup>
              ...
              <td width="30%">
                <FormItem prop="c15">
                  <RadioGroup v-model="formRecord.c15">
                    <Radio label="有" :disabled="help.c15">有</Radio>
                    <Radio label="无" :disabled="help.c15">无</Radio>
                  </RadioGroup>
              ...
              <td colspan="3">
                <FormItem prop="c12">
                  <RadioGroup v-model="formRecord.c12">
                    <Radio label="交流变频" :disabled="help.c12">交流变频</Radio>
                    <Radio label="直流变频" :disabled="help.c12">直流变频</Radio>
                    <Radio label="其他" :disabled="help.c12">其他</Radio>
                  </RadioGroup>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c12" @click="showModal2('c12')"></Icon>
                </FormItem>
                <FormItem prop="c13">
                  <Input type="text" v-model="formRecord.c13" style="width:80px;" :disabled="formRecord.c12 !== '其他' || help.c13"></Input>
              ...
              <td colspan="3">
                <FormItem prop="c14">
                  <RadioGroup v-model="formRecord.c14">
                    <Radio label="有" :disabled="help.c14">有</Radio>
                    <Radio label="无" :disabled="help.c14">无</Radio>
                  </RadioGroup>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c14" @click="showModal2('c14')"></Icon>
                </FormItem>
                <FormItem prop="c48">
                  <Input type="text" placeholder="电加热装置输入功率(W)" v-model="formRecord.c48" style="width:200px;" :disabled="formRecord.c14 !== '有' || help.c48"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c59">
                  <Input type="text" v-model="formRecord.c59" :disabled="help.c59"></Input>
              ...
              <td>
                <FormItem prop="c16">
                  <RadioGroup v-model="formRecord.c16">
                    <Radio label="有" :disabled="help.c16">有</Radio>
                    <Radio label="无" :disabled="help.c16">无</Radio>
                  </RadioGroup>
              ...
              <td>
                <FormItem prop="c17">
                  <RadioGroup v-model="formRecord.c17">
                    <Radio label="有" :disabled="help.c17">有</Radio>
                    <Radio label="无" :disabled="help.c17">无</Radio>
                  </RadioGroup>
              ...
              <td>
                <FormItem prop="c56">
                  <RadioGroup v-model="formRecord.c56">
                    <Radio label="有" :disabled="help.c56">是</Radio>
                    <Radio label="无" :disabled="help.c56">否</Radio>
                  </RadioGroup>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c45">
                  <Input type="text" v-model="formRecord.c45" :disabled="help.c45"></Input>
              ...
              <td>
                <FormItem prop="c47">
                  <Input type="text" v-model="formRecord.c47" :disabled="help.c47"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c46">
                  <Input type="text" v-model="formRecord.c46" :disabled="help.c46"></Input>
              ...
              <td>
                <FormItem prop="c26">
                  <Input type="text" v-model="formRecord.c26" :disabled="help.c26"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c27">
                  <Input type="text" v-model="formRecord.c27" style="width:80px;" :disabled="help.c27"></Input>
                ...
                <FormItem prop="c49">
                  <Input type="text" v-model="formRecord.c49" style="width:80px;" :disabled="help.c49"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c49" @click="showModal2('c49')"></Icon>
                </FormItem>
                <span style="display: inline-block;height: 32px;line-height: 32px;">x</span>
                <FormItem prop="c50">
                  <Input type="text" v-model="formRecord.c50" style="width:80px;" :disabled="help.c50"></Input>
              ...
              <td>
                <FormItem prop="c28">
                  <Input type="text" v-model="formRecord.c28" style="width:80px;" :disabled="help.c28"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c28" @click="showModal2('c28')"></Icon>
                </FormItem>
                <span style="display: inline-block;height: 32px;line-height: 32px;">x</span>
                <FormItem prop="c51">
                  <Input type="text" v-model="formRecord.c51" style="width:80px;" :disabled="help.c51"></Input>
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c54">
                  <Input type="text" v-model="formRecord.c54" :disabled="help.c54"></Input>
              ...
              <td>
                <FormItem prop="c55">
                  <Input type="text" v-model="formRecord.c55" :disabled="help.c55"></Input>
        ...
        <Card :bordered="false">
          ...
          <table id="table4">
            ...
            <tr>
              <td>
                <FormItem prop="c60">
                  <Input type="text" v-model="formRecord.c60" :disabled="help.c60"></Input>
                  <Icon type="ios-help-circle-outline" size="20" v-if="help.c60" @click="showModal2('c60')"></Icon>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c61">
                  <Input type="text" v-model="formRecord.c61" :disabled="help.c61"></Input>
...
export default {
  ...
  methods: {
    ...
    submitWorkorder () {
      ...
      axios.get('/workorder/save.do', {
        params: {
          productType: 'T33',
          productTypeName: '转速可控型房间空气调节器2013版',
          productModel: this.formRecord.c4,
          page: '备案页',
      ...
      this.$store.state.app.defaultData.forEach((e) => {
        if (e.labValue === '/'  || e.labValue == null) {
          ...
          if (e.recId === 'c8') {
            ...
            if (e.labValue.indexOf('直流') > -1) {
              that.formRecord[e.recId] = '直流变频'
            } else if (e.labValue.indexOf('交流') > -1) {
              that.formRecord[e.recId] = '交流变频'
            } else if (e.labValue.indexOf('其他') > -1) {
              that.formRecord[e.recId] = '其他'
            } else {
              that.formRecord[e.recId] = ''
            }
    ...
    submitRecord () {
      let _this = this
      this.formRecord.c9 = this.formatDate(this.formRecord.c9)
  ...
  computed: {
    ...
    disabledc6 () {
      return this.formRecord.c57 !== '单冷式' && this.$store.state.app.requiredStr.indexOf('c6,') === -1
    },
    disabledc25 () {
      return this.formRecord.c57 !== '热泵型' && this.$store.state.app.requiredStr.indexOf('c25,') === -1
    },
    disabledc42 () {
      return this.formRecord.c57 !== '热泵型' && this.$store.state.app.requiredStr.indexOf('c42,') === -1
    },
    disabledc37 () {
      return this.formRecord.c57 !== '热泵型' && this.$store.state.app.requiredStr.indexOf('c37,') === -1
    },
    ruleRecord () {
      ...
      let checkc6 = (rule, vaule, callback) => {
        if (!this.help.c6 && this.formRecord.c6 !== '' && !decimal2.test(this.help.c6)) {
          callback('两位小数')
        } else {
          callback()
        }
        ...
        let errorc37 = ''
        let nxdj = ""
        if (this.$store.state.app.requiredStr.indexOf('c6,') > -1 && this.formRecord.c6 === '') {
          callback('模板要求必填')
        } else {
          callback()
        }
      ...
      let checkc37 = (rule, vaule, callback) => {
        if (!this.help.c37 && this.formRecord.c37 !== '' && !decimal2.test(this.help.c37)) {
          callback('两位小数')
        } else {
          callback()
        }
        ...
        let errorc37 = ''
        let nxdj = ""
        if (this.$store.state.app.requiredStr.indexOf('c37,') > -1 && this.formRecord.c37 === '') {
          callback('模板要求必填')
        } else {
          callback()
        }
      ...
      let checkc25 = (rule, value, callback) => {
        if (this.$store.state.app.requiredStr.indexOf('c25,') > -1 && this.formRecord.c25 === '') {
          callback('模板要求必填')
        } else {
          callback()
        }
      }
      let checkc42 = (rule, value, callback) => {
        if (this.$store.state.app.requiredStr.indexOf('c42,') > -1 && this.formRecord.c42 === '') {
          callback('模板要求必填')
        } else {
          callback()
        }
      ...
      let checkc38 = (rule, value, callback) => {
        if (!this.help.c38 && this.formRecord.c38 !== '' && !decimal25.test(this.help.c38)) {
          callback('至少两位小数')
        } else {
          callback()
        }
      }
      let checkc35 = (rule, value, callback) => {
        if (!this.help.c35 && this.formRecord.c35 !== '' && !decimal25.test(this.help.c35)) {
          callback('至少两位小数')
        } else {
          callback()
        }
      }
      let checkc31 = (rule, value, callback) => {
        if (!this.help.c31 && this.formRecord.c31 !== '' && !decimal15.test(this.help.c31)) {
          callback('至少一位小数')
        } else {
          callback()
        }
      }
      let checkc40 = (rule, value, callback) => {
        if (!this.help.c40 && this.formRecord.c40 !== '' && !decimal15.test(this.help.c40)) {
          callback('至少一位小数')
        } else {
          callback()
        }
